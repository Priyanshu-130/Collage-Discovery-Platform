...
const CardSkeleton = () => (<div className="flex flex-col overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm p-0 animate-pulse">
...
const GridSkeleton = ({ count }: {
    ...
    {Array.from({ length: count }).map((_, idx) => (<CardSkeleton key={`skeleton-${idx}`}/>))}
  </div>);
const DetailsSkeleton = () => (<div className="space-y-6 animate-pulse">
...
const DashboardSkeleton = () => (<div className="space-y-8 animate-pulse">
